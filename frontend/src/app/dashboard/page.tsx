                ...
                <>
                  ...
                  <div className="mb-6 bg-white/80 dark:bg-gray-800/80 rounded-xl p-6 shadow-lg">
                    ...
                    {loadingLeases ? (
                      ...
                      <div className="text-center text-gray-600 dark:text-gray-300">لا توجد عقود حالياً</div>
                    ) : (
                      <div className="overflow-x-auto">
                        <table className="min-w-full text-right">
                          <thead>
                            <tr className="bg-orange-100 dark:bg-orange-800 text-orange-700 dark:text-orange-200">
                              <th className="py-2 px-4">الوحدة</th>
                              <th className="py-2 px-4">المالك</th>
                              <th className="py-2 px-4">تاريخ البداية</th>
                              <th className="py-2 px-4">تاريخ النهاية</th>
                              <th className="py-2 px-4">مراجعة العقد وتحميله</th>
                            </tr>
                          </thead>
                          <tbody>
                            {leases.map((lease) => (
                              <tr key={lease._id} className="border-b border-gray-200 dark:border-gray-800">
                                ...
                                <td className="py-2 px-4">
                                  <button className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded-lg font-semibold" onClick={() => handleView(lease._id)}>مراجعة العقد وتحميله <i className="fa fa-file-alt" aria-hidden="true"></i></button>
                                </td>
                              </tr>
                            ))}
                          </tbody>
                      ...
                      <div className="overflow-x-auto">
                        <table className="min-w-full text-right">
                          <thead>
                            <tr className="bg-orange-100 dark:bg-orange-800 text-orange-700 dark:text-orange-200">
                              <th className="py-2 px-4">الوحدة</th>
                              <th className="py-2 px-4">المستأجر</th>
                              <th className="py-2 px-4">تاريخ البداية</th>
                              <th className="py-2 px-4">تاريخ النهاية</th>
                              <th className="py-2 px-4">مراجعة العقد وتحميله</th>
                            </tr>
